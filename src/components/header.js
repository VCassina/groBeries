...
function Header() {
  ...
  return (
    <header className="header rounded-2xl bg-green-400 text-white drop-shadow-lg p-2 flex justify-center border-solid border-4 border-slate-600">
      <div className="header-content flex flex-col items-center justify-center">
        ...
        <p className="drop-shadow-md">Toujours plus pratique qu'un bloc-note !</p>
      </div>
    </header>
  );
}
